      ...
      >
        {generatedKey && (
          ...
          >
            ...
            Please copy this generated API Key value as it will be displayed
            only for the current browser session. (The API Key will not be
              ...
              <Box py={2}>
                ...
                <Box display="flex" flexWrap="wrap" gridGap={16} mt={1}>
                  ...
                  <FormControl
                    ...
                    style={{ minWidth: 160, flex: 1 }}
                  >
                    <InputLabel id="api-key-validity-label">
                      Validity Period
                    </InputLabel>
                    <Select
                      ...
                      onChange={e =>
                        setValiditySelection(e.target.value as string)
                      }
                  ...
                  <FormControl
                    ...
                    style={{ minWidth: 160, flex: 1 }}
                  >
                    <InputLabel id="api-key-security-label">
                    ...
                    <Select
                      ...
                      onChange={e =>
                        setSecurityRestriction(
                          e.target.value as SecurityRestriction,
                        )
                      }
