...
- `wso2-api-manager-backend/index.html`
...
1. **For the Backend Plugin (`wso2-api-manager-backend`):**
   ```bash
   npx @redocly/cli build-docs wso2-api-manager-backend@v1 -o ./wso2-api-manager-backend/index.html
   ```
